...
export default function WhatsAppButton() {
  ...
  return (
    <div className="relative flex items-center gap-4">
      ...
      >
        {/* BREATHING AMBIENCE - Glow stays centered behind the button */}
        ...
        <button
          onClick={handleClick}
          className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-[1.25rem] bg-[#1A365D] text-white shadow-2xl overflow-hidden transition-all duration-700 border border-white/10 group-hover:border-[#25D366]/50 group-hover:shadow-[0_20px_40px_rgba(37,211,102,0.3)]"
        >
          ...
          <div className="relative z-10 flex items-center justify-center">
            <svg 
              viewBox="0 0 24 24" 
              className="w-7 h-7 md:w-8 h-8 fill-current group-hover:scale-110 transition-transform duration-500 ease-out"
        ...
        {/* PRESTIGE TOOLTIP - Opens to the RIGHT for Left-anchored button */}
        <AnimatePresence>
          {isHovered && (
            <motion.div
            ...
            >
              <div className="bg-white/90 backdrop-blur-xl border border-gray-100 px-5 py-3 rounded-2xl shadow-2xl flex flex-col items-start min-w-[200px]">
                ...
                {/* Arrow pointing LEFT back to the button */}
