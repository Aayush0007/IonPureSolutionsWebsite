...
import SignBoard from "./components/layout/MaintenanceMode";
// Dat
...
function App() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#FDFDFD] overflow-x-hidden font-body">
      ...
      <div
        className={`fixed bottom-6 left-6 z-[9999] transition-all duration-700 ease-in-out 
    ${
      isFooterVisible
      ...
      {/* ChatBot Container */}
      <div
        className={`fixed bottom-6 right-6 z-[9999] transition-all duration-700 ease-in-out 
    ${
      isFooterVisible
        ? "opacity-0 translate-y-32 pointer-events-none"
        : "opacity-100 translate-y-0 pointer-events-auto"
